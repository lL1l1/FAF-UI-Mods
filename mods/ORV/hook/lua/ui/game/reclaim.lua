...
if exists("/mods/UMT/mod_info.lua") and import("/mods/UMT/mod_info.lua").version >= 4 then
    LayoutFor = import("/mods/UMT/modules/Layouter.lua").ReusedLayoutFor
    ...
    if VERSION >= 3745 then
        ...
        ---@type WorldLabel
        local OldWorldLabel = WorldLabel

        WorldLabel = Class(OldWorldLabel)
        {
    ...
    for i = 1, 10 do
        WARN("Optimized Reclaim View requires UI mod tools version 4 and higher!!!")
    end
end
