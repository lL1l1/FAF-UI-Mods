...
UnitIconAssignments = {
    { BlueprintId = "UEL0203", IconSet = "icon_land2_amphibian" },
    { BlueprintId = "URL0203", IconSet = "icon_land2_amphibian" },
    { BlueprintId = "XSL0203", IconSet = "icon_land2_amphibian" },
    { BlueprintId = "XAL0203", IconSet = "icon_land2_amphibian" },
}
